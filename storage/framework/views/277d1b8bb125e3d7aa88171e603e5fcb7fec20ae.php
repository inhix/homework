<ul class="sidebar-menu">
    ...
    <li><a href="<?php echo e(route('users.index')); ?>"><i class="fa fa-users"></i> <span>Пользователи</span></a></li>
    <li><a href="<?php echo e(route('subscribers.index')); ?>"><i class="fa fa-user-plus"></i>
            <span>Подписчики</span></a></li>
