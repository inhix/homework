...
mix.scripts([
    ...
    'resources/assets/admin/dist/js/AdminPostsScripts.js',
    'resources/assets/admin/dist/js/AdminTagsScripts.js',
    'resources/assets/admin/dist/js/AdminCategoriesScripts.js',
    'resources/assets/admin/dist/js/AdminUsersScripts.js',
    'resources/assets/admin/dist/js/AdminMatchesScripts.js'
], 'public/js/admin.js');
...
mix.copy('storage/app/uploads', 'public/uploads');
